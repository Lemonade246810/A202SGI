...
public class PatientPrescriptionView extends AppCompatActivity {
    String patientName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout = findViewById(R.id.idLogout9);
    ...
    private void getAppointment() {
        ...
        databaseReference.orderByChild("patientName").equalTo(patientName).addChildEventListener(new ChildEventListener() {
            @Override
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(PatientPrescriptionView.this, "Network Issue..", Toast.LENGTH_SHORT).show();
...
//        }
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent appointment = new Intent(PatientPrescriptionView.this, DoctorPatientPrescription.class);
        ...
        viewBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference databaseReference2 = firebaseDatabase.getReference("Clinic");
                Query query = databaseReference2.orderByChild("clinicName").equalTo(appModel.getClinicName());
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot2) {
                        if(snapshot2.exists())
                        {
                            for (DataSnapshot userSnapshot : snapshot2.getChildren()) {
                                ...
                                Intent i = new Intent(PatientPrescriptionView.this, AdministratorMap.class);
                                // on below line we are passing our course modal
                                i.putExtra("latitude", latitude);
                                i.putExtra("longitude", longitude);
                                i.putExtra("clinic", appModel.getClinicName());
                                startActivity(i);
                            }

                        }
                        else{
                            Toast.makeText(PatientPrescriptionView.this, "Failed", Toast.LENGTH_SHORT).show();
